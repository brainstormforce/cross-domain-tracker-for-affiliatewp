...
final class Affiliate_WP_Track_External_Visits {
	...
	public function cdtawp_connection_section_callback() {
		...
		$affiliate_api_link = $affiliate_api_link ? '<i>( ' . esc_url( $affiliate_api_link ) . ' )</i>' : '';
	...
	public function callback_input_text( $args ) {
		...
		?>
		<input style="width: 30%" type="text" id="<?php echo esc_attr( $args['id'] ); ?>" name="<?php echo CDTAWP_SETTINGS_GROUP; ?>[<?php echo $args['name']; ?>]" value="<?php echo $value; ?>"/>
